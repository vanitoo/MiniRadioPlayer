...
class MiniRadio(QWidget):
    ...
    def _build_ui(self):
        ...
        self.start_edit.setMaximumWidth(180)
        ...
        self.setStyleSheet(
            ...
            QLineEdit, QGroupBox { background:#161821; border:1px solid #2a2d36; border-radius:6px; }
            QPushButton { background:#232633; border:1px solid #3a3f4b; padding:6px 12px; border-radius:6px; }
            QPushButton:hover { background:#2b2f3e; }
            QGroupBox::title { subcontrol-origin: margin; left:10px; padding:0 4px; }
            QSlider::groove:horizontal { height:6px; background:#2a2d36; border-radius:3px; }
            QSlider::handle:horizontal { width:14px; background:#5b6bff; margin:-4px 0; border-radius:7px; }
            """
        )
